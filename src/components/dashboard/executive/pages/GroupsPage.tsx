    ...
    <>
      {destaque && (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5">
          <Highlight icon={Crown} label="Maior receita" grupo={destaque.byReceita.grupo} valor={formatCurrencyK(destaque.byReceita.receita)} tone="bg-emerald-50 text-emerald-600" />
